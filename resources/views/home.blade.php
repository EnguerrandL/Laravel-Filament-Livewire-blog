<x-app-layout title='Home Page'>
    ...
    @section('hero')
        <div class="w-full text-center py-32">
            <h1 class="text-2xl md:text-3xl font-bold text-center lg:text-5xl text-gray-700">
               {{ __('home.hero.title') }} <span class="text-yellow-500">&lt;YELO&gt;</span> <span class="text-gray-900"> {{__('home.news')}}</span>
            </h1>
    ...
    <div class="mb-10 w-full">
        ...
        <h2 class="mt-16 mb-5 text-3xl text-yellow-500 font-bold">{{__('home.latests_posts')}}</h2>
